"""Moved to waxx.util.live_od.gui.fk_tof_window on 2026-09-18 (liveOD is lab-independent and lives in waxx).
...
import waxx.util.live_od.gui.fk_tof_window as _impl

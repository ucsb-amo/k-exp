"""Moved to waxx.util.live_od.camera_connection_widget on 2026-09-18 (liveOD is lab-independent and lives in waxx).
...
import waxx.util.live_od.camera_connection_widget as _impl

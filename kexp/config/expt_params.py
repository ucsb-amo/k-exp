...
class ExptParams(ExptParamsWaxx):
    def __init__(self):
        ...
        self.t_hf_lightsheet_rampdown = .74
        ...
        self.t_hf_tweezer_1064_rampdown = 100.e-3 # 200.e-3 
        self.t_hf_tweezer_1064_rampdown2 = 566.e-3   
        self.t_hf_tweezer_1064_rampdown3 = 500.e-3 
        ...
        self.v_xshim_current = 0.0
        self.v_yshim_current = 0.0
        ...
        self.v_pd_hf_lightsheet_rampdown_end = .479 #4.16
        ...
        self.v_pd_hf_tweezer_1064_rampdown_end = 1.16 # 1.13
        self.v_pd_hf_tweezer_1064_rampdown2_end = 0.16 # 0.15 # .21
        self.v_pd_hf_tweezer_1064_rampdown3_end = .5
        ...
        self.v_hf_tweezer_paint_amp_max = .536 # -1.7
        ...
        self.i_hf_tweezer_load_current = 193.2
        self.i_hf_tweezer_evap1_current = 193.6
        self.i_hf_tweezer_evap2_current = 193.846 # 193.

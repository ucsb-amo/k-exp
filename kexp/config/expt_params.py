...
class ExptParams():
    def __init__(self):
        ...
        self.v_pd_lightsheet_rampdown_end = 1.3 #4.16
        ...
        self.v_pd_tweezer_1064_ramp_end = 9.1
        ...
        self.i_tweezer_load_current = 192.6
        self.i_tweezer_evap1_current = 194.6

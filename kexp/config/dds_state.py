...
dds_state = [[
    ...
    DDS(1,1,115.00*MHz,0.2500,0.0000),
    DDS(1,2,95.42*MHz,0.3000,1.6000),
    DDS(1,3,134.43*MHz,0.3000,0.8000)],[
    DDS(2,0,80.00*MHz,0.4500,0.0000),
    DDS(2,1,53.85*MHz,0.1000,0.0000),
    DDS(2,2,100.00*MHz,0.0800,0.0000),
    DDS(2,3,80.00*MHz,0.2500,0.0000)]]
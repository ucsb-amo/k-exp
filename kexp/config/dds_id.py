...
class dds_frame():
    ...
    def __init__(self, dds_state = dds_state, dac_frame_obj:dac_frame = [], core = DummyCore()):
        ...
        self.push = self.dds_assign(3,0, ao_order = 1, transition = 'D2')
        self.d2_2d_r = self.dds_assign(3,1, ao_order = 1, transition = 'D2')
        self.d2_2d_c = self.dds_assign(3,2, ao_order = -1, transition = 'D2')
        self.d2_3d_r = self.dds_assign(3,3, ao_order = 1, transition = 'D2')
        self.d2_3d_c = self.dds_assign(4,0, ao_order = -1, transition = 'D2')
        self.mot_killer = self.dds_assign(4,1, ao_order = -1, transition = 'D2')
        self.beatlock_ref = self.dds_assign(4,2)
        self.d1_3d_c = self.dds_assign(4,3, ao_order = -1, transition = 'D1',
                                        dac_ch_vpd = self._dac_frame.vva_d1_3d_c.ch)
        self.d1_3d_r = self.dds_assign(5,0, ao_order = 1, transition = 'D1',
                                        dac_ch_vpd = self._dac_frame.vva_d1_3d_r.ch)
        self.imaging = self.dds_assign(5,1, ao_order = 1)
        self.op_r = self.dds_assign(5,2, ao_order = 1, transition = 'D1')
        self.optical_pumping = self.dds_assign(5,3, ao_order = -1, transition = 'D1')

...
xy_basler_params = BaslerParams(serial_number='40316451',camera_select='xy_basler_params')
z_basler_params = BaslerParams(serial_number='40416468',camera_select='z_basler_params',

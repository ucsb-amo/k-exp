...
class magnetometry(EnvExperiment, Base):
    ...
    def prepare(self):
        ...
        # self.p.frequency_rf_state_xfer_sweep_center = 459.43e6
        # self.p.frequency_rf_state_xfer_sweep_fullwidth = 506.329e3
        # self.p.frequency_rf_state_xfer_sweep_fullwidth = 1037.974e3
        # self.xvar('frequency_rf_state_xfer_sweep_fullwidth', np.linspace(700.,1200.,30)*1.e3)
        ...
        # self.xvar('frequency_rf_state_xfer_sweep_center', 459.5e6 + np.linspace(-.2,.2,20)*1.e6)
        # self.xvar('frequency_rf_state_xfer_sweep_center', 461.e6 + np.linspace(-20.,20.,80)*1.e6)
        # self.xvar('frequency_rf_state_xfer_sweep_center', 461.e6 + np.linspace(-5.,5.,80)*1.e6)
        # self.xvar('frequency_rf_state_xfer_sweep_center', np.linspace(460.,480.,30)*1.e6)
        # self.p.frequency_rf_state_xfer_sweep_center = 476.e6
        self.p.do_sweep = 1
        # self.xvar('do_sweep',[0,1])
        # self.xvar('frequency_rf_state_xfer_sweep_fullwidth',np.linspace(20.,500.,15)*1.e3)

...
class sigma_z(EnvExperiment, Base):
    ...
    def prepare(self):
        ...
        self.p.t_between_pulses_mu = 25000  # from pulse start to next pulse start, in mu

        self.p.t_raman_pulse = 0.
        self.p.t_raman_pulse_offset = 127.e-9
        self.xvar('t_raman_pulse', self.p.t_raman_pi_pulse * np.linspace(0.,1.,8))
    ...
    def analyze(self):
        ...
        # # Mean APD over all pulses, grouped by xvar value (mean Â± SEM)

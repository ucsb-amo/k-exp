...
class hf_raman(EnvExperiment, Base):
    ...
    def prepare(self):
        ...
        # self.xvar('frequency_raman_transition',119.4638e6 + np.linspace(-1.e3,1.e3,10))
        ...
        # self.xvar('t_raman_pulse', [0,8.69e-06])
        # self.p.t_raman_pulse = 7.69e-06 / 2 # -1 --> -2
        self.p.t_raman_pulse = 9.2826e-06 / 2 # -1 --> 0
        ...
        # self.xvar('t_tof',np.linspace(600.,2000.,10)*1.e-6) 
        self.p.t_tof = 80.e-6

...
class hf_bec(EnvExperiment, Base):
    ...
    def prepare(self):
        ...
        self.p.frequency_eo_980 = 339.e6

        # self.xvar('t_tweezer_paint_rampdown',np.linspace(0.0,10.,5)*1.e-3)
        
        # self.xvar('t_tweezer_hold', np.linspace(0.,1500.,3) * 1.e-3)
    ...
    def scan_kernel(self):
        ...
        self.prepare_hf_tweezers(do_tweezer_evap_2=True, squeeze=False)
        self.ry_405.reboot()

...
class hf_bec(EnvExperiment, Base):
    ...
    def prepare(self):
        ...
        self.adjust('amp_dds_405',0.04,0.145)
#   
        ...
        self.adjust('t_tweezer_hold',0.,1.)
        ...
        self.p.v_pd_ry_405 = 2.0
        self.adjust('v_pd_ry_405',0.,2.5)

        self.p.v_pd_ry_980 = 2.8
        self.adjust('v_pd_ry_980',0.,2.5)

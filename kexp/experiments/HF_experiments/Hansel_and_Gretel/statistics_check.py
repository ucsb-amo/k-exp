...
from kexp.experiments.HF_experiments.Hansel_and_Gretel.expt_params_feedback import ExptParams as ExptParamsFeedback
...
class feedback(EnvExperiment, Base, Feedback):
    ...
    def prepare(self):
        ...
        self.p.N_repeats = 7
        self.p.N_pulses = 16 # number of steps of evolution

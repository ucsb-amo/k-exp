...
class tof_scan(EnvExperiment, Base):
    ...
    def build(self):
        ...
        # self.xvar('t_feshbach_field_rampup',np.linspace(.005,.1,20))

        # self.xvar('i_evap1_current',np.linspace(9.,13.,8))
        # self.xvar('v_pd_lightsheet_rampdown_end',np.linspace(3.,.7,6))
        ...
        self.p.v_pd_lightsheet_rampdown2_end = 0.17
        ...
        # self.xvar('t_tof',np.linspace(20.,100.,15)*1.e-6)

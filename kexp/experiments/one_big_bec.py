...
class tweezer_load(EnvExperiment, Base):
    ...
    def prepare(self):
        ...
        # self.p.amp_tweezer_list = [[a] for a in a_list_scan]
        ...
        # self.xvar('v_pd_tweezer_1064_rampdown2_end',np.linspace(.03,.1,20)) 
        ...
        # self.xvar('v_pd_tweezer_1064_rampdown3_end',np.linspace(.15,2.,20))

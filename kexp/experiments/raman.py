...
class tweezer_load(EnvExperiment, Base):
    ...
    def prepare(self):
        ...
        # self.xvar('frequency_raman_sweep_center', 41.10e6 + np.arange(-30.e3,35.e3,self.p.frequency_raman_sweep_width))
        ...
        self.xvar('t_raman_pulse',np.linspace(0.,500.,200)*1.e-6)

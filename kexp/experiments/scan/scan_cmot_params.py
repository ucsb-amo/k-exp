...
class scan_cmot_params(EnvExperiment, Base):
    ...
    def build(self):
        ...
        # self.p.xvar0_detune_d1_c_d1cmot = np.linspace(5.5,7.0,6)
        self.p.xvar_detune_d2_r_d1cmot = np.linspace(-2.5,-3.5,6)

        self.p.xvar_amp_d2_r_d1cmot = np.linspace(0.03,.04,6)
    ...
    def run(self):
        ...
        for xvar_0 in self.p.xvar_detune_d2_r_d1cmot:

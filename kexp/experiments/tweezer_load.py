...
class mag_trap(EnvExperiment, Base):
    ...
    def prepare(self):
        ...
        # self.xvar('i_tweezer_load_current',np.linspace(180.,195.,20))
        # self.p.i_tweezer_load_current = 192.6

        # self.xvar('i_tweezer_evap1_current',np.linspace(193.,198.,8))
        # self.p.i_tweezer_evap1_current = 194.6

        # self.xvar('v_pd_tweezer_1064_ramp_end',np.linspace(5.,9.1,10))

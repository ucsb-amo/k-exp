...
class tweezer_paint(EnvExperiment, Base):
    ...
    def build(self):
        ...
        self.xvar('v_pd_lightsheet_rampup_end',np.linspace(8.5,9.99,3))

        self.xvar('i_evap1_current',np.linspace(190.,194.,2))
        self.xvar('t_lightsheet_rampdown',np.linspace(.02,1.,2))

        self.xvar('v_pd_lightsheet_rampdown_end',np.linspace(1.,6.,2))
        ...
        self.xvar('t_tof',np.linspace(25.,900.,3)*1.e-6)

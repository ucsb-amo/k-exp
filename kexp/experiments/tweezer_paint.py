...
class tweezer_paint(EnvExperiment, Base):
    ...
    def build(self):
        ...
        self.xvar('t_tweezer_1064_rampdown',np.linspace(0.01,.06,6))
        ...
        # self.xvar('v_pd_tweezer_1064_rampdown3_end',np.linspace(.3,2.,6)) 
        ...
        # self.xvar('t_tof',np.linspace(10.,800.,20)*1.e-6)

...
class tweezer_load(EnvExperiment, Base):
    ...
    def prepare(self):
        ...
        # self.xvar('t_raman_stateprep_pulse',np.linspace(0.,26.e-6,10))
    ...
    def scan_kernel(self):
        ...
        # self.dds.imaging.on()
        # self.raman.on()
        # self.ttl.pd_scope_trig.pulse()
        # self.raman.off()
        
        self.set_imaging_detuning(frequency_detuned = self.p.hf_imaging_detuning)
        self.dds.imaging.set_dds(amplitude=.22)

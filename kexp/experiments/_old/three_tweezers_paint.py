...
class tweezer_load(EnvExperiment, Base):
    ...
    def prepare(self):
        ...
        self.xvar('t_tof',np.linspace(800.,2500.,10)*1.e-6)
        ...
        # self.xvar('v_tweezer_paint_amp_max',np.linspace(-5.5,-1.,20))
        ...
        # self.xvar('v_pd_tweezer_1064_rampdown3_end',np.linspace(1.,3.,3))

...
class tweezer_load(EnvExperiment, Base):
    ...
    def prepare(self):
        ...
        self.p.frequency_detuned_hf_pci = 0.e6
        ...
        self.camera_params.exposure_time = 100.e-3
        self.camera_params.em_gain = 2.
        # self.p.t_imaging_pulse = self.camera_params.exposure_time
        self.xvar('t_imaging_pulse',np.linspace(.01e-3,10.e-3,20))
        self.p.t_imaging_pulse = 100.e-3
    ...
    def scan_kernel(self):
        ...
        detuning = high_field_imaging_detuning(i_outer=self.p.i_evap3_current)
        self.set_imaging_detuning(detuning + self.p.frequency_detuned_hf_pci)

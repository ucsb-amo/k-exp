...
class tweezer_load(EnvExperiment, Base):
    ...
    def prepare(self):
        ...
        # self.xvar('frequency_detuned_imaging',np.linspace(0.,280,20)*1.e6)
        ...
        # self.xvar('t_raman_pulse',[12.e-6,24.e-6]*1)
        self.p.t_raman_pulse = 84.e-6

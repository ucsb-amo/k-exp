...
class tweezer_load(EnvExperiment, Base):
    ...
    def prepare(self):
        ...
        self.p.frequency_raman_transition = 41.235e6 + 500.e3
        ...
        # self.xvar('phase_slm_mask',np.linspace(0.*np.pi,1.*np.pi,10))
        ...
        # self.scope = self.scope_data.add_scope('USB0::0x0699::0x03B4::C010652::INSTR')
    ...
    def scan_kernel(self):
        ...
        # self.set_imaging_detuning(frequency_detuned = self.p.frequency_detuned_imaging_m1)
        self.dds.imaging.set_dds(amplitude=.15)

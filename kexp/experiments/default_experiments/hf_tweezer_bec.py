...
class hf_bec(EnvExperiment, Base):
    ...
    def scanning(self):
        ...
        self.p.v_pd_hf_tweezer_1064_rampdown2_end = 2.5

        # self.xvar('v_pd_hf_tweezer_1064_rampdown2_end',np.linspace(1.5,7.,8))

        # self.xvar('v_hf_tweezer_paint_amp_max',np.linspace(-0.6,1.8,8))

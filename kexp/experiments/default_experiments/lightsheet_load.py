...
class mag_trap(EnvExperiment, Base):
    ...
    def prepare(self):
        ...
        # self.xvar('t_tof',np.linspace(200,700.,5)*1.e-6)
        ...
        # self.xvar('i_magtrap_init',[52.,87.])
        # self.p.i_magtrap_init = 60.5 # makbe keep maybe don't
        ...
        # self.p.v_pd_lightsheet_rampup_end=8.15

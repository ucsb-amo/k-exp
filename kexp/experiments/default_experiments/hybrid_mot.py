...
class gm_tof(EnvExperiment, Base):
    ...
    def prepare(self):
        ...
        # self.xvar('detune_d1_c_mot',np.linspace(0.,10.,5))
        # self.xvar('v_pd_d1_c_mot',np.linspace(1.,4.,10))
        # self.xvar('detune_d1_r_mot',np.linspace(0.,10.,5))
        ...
        # self.xvar('detune_d2_c_mot', np.linspace(-2.4,-1.,5))
        self.p.detune_d2_c_mot = -1.7
        # self.xvar('detune_d2_r_mot', np.linspace(-5,-1.,5))
        self.p.detune_d2_r_mot = -3.2
    ...
    def scan_kernel(self):
        ...
        # self.p.detune_d2_c_mot = self.p.detune_d2
        # self.p.detune_d2_r_mot = self.p.detune_d2 * 2

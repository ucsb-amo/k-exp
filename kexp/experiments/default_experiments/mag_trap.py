...
class mag_trap(EnvExperiment, Base):
    ...
    def prepare(self):
        ...
        # self.xvar('v_yshim_current_magtrap',np.linspace(2.,3.9,10))
        self.p.v_zshim_current_magtrap = 0.75
        self.p.v_xshim_current_magtrap = 0.25
        self.p.v_yshim_current_magtrap = 3.75

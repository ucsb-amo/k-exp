...
class tweezer_load(EnvExperiment, Base):
    ...
    def prepare(self):
        ...
        self.xvar('i_lf_lightsheet_evap1_current',np.linspace(15.,20.,20))
        # self.xvar('i_lf_evap2_current',np.linspace(17.,19.,8))
        # self.xvar('i_lf_evap3_current',np.linspace(17.,19.,8))
        self.p.i_lf_lightsheet_evap1_current = 18.37
        # self.p.i_lf_evap1_current = 17.58
        self.p.i_lf_tweezer_load_current = 17.83

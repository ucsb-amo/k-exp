...
class tweezer_snug(EnvExperiment, Base):
    ...
    def prepare(self):
        ...
        # self.xvar('t_tof',np.linspace(500.,4000.,20)*1.e-6)
        # self.xvar('dummy',[0]*3)
        self.p.t_tof = 3300.e-6
        # self.p.t_tof = 400.e-6
        # self.xvar('t_tof',[3000*1.e-6]*3)

        # self.xvar('beans',[0]*1)

        # self.xvar('x_move',np.linspace(-4.5,-2.75,20)*1.e-6)
        self.p.x_move = -3.5e-6

        # self.xvar('t_tweezer_single_move',np.linspace(3.,50.,20)*1.e-3)
        self.p.t_tweezer_single_move = 12.894e-3

        # self.xvar('t_tunnel',np.linspace(0.,100.,1000)*1.e-3)
        self.xvar('t_tunnel',[42*1.e-3]*3)
        self.p.t_tunnel = 42.e-3
        ...
        # self.xvar('v_pd_lightsheet_rampdown_end',np.linspace(4.,7.5,10))
        ...
        # self.xvar('v_tweezer_paint_amp_max',np.linspace(0.,3.,20))
        ...
        # self.xvar('v_pd_tweezer_1064_rampdown3_end',np.linspace(.5,2.,15))
        ...
        # self.xvar('i_tunnel_current',np.linspace(190.,197.4,20))

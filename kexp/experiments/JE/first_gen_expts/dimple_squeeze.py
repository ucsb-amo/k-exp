...
class tweezer_snug(EnvExperiment, Base):
    ...
    def prepare(self):
        ...
        # self.xvar('i_evap2_current',np.linspace(196.5,199.,20))
        self.p.i_evap2_current = 198.7
        ...
        # self.xvar('t_tweezer_1064_rampdown',np.linspace(0.012,.2,8))
        self.p.t_tweezer_1064_rampdown = .119
        ...
        # self.xvar('t_tweezer_1064_rampdown2',np.linspace(0.05,.3,8))
        self.p.t_tweezer_1064_rampdown2 = .25

        # self.xvar('v_pd_tweezer_1064_rampdown3_end',np.linspace(.3,3.,20))
        self.p.v_pd_tweezer_1064_rampdown3_end = 2.2

...
class mag_trap(EnvExperiment, Base):
    ...
    def prepare(self):
        ...
        self.xvar('i_lf_lightsheet_evap1_current',np.linspace(3.,75.,100))
        # self.p.i_lf_lightsheet_evap1_current = 13.6
        self.p.i_lf_lightsheet_evap1_current = 19.

        self.p.i_lf_image_current = 18.
 
        # self.xvar('v_pd_lf_lightsheet_rampdown_end',np.linspace(.2,2.,8))
        self.p.v_pd_lf_lightsheet_rampdown_end = .5

        # self.xvar('t_lf_lightsheet_rampdown',np.linspace(100.,1500.,8)*1.e-3)
        self.p.t_lf_lightsheet_rampdown = .6

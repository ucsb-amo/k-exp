...
# 
        ...
        self.xvar('i_hf_squeeze1_current',np.linspace(182.,192.,5))
        self.p.i_hf_squeeze1_current = 192.

        # self.xvar('v_paint_amp_end',np.linspace(self.p.v_hf_tweezer_paint_amp_max,-7.,8))
        self.p.v_paint_amp_end = -7.

        self.p.t_ramp_down_painting_amp = 300.e-3

        self.xvar('t_tweezer_hold',np.linspace(41.,45.,20)*1.e-3)
    ...
    def scan_kernel(self):
        ...
        self.set_high_field_imaging(i_outer=self.p.i_hf_squeeze1_current)

...
# 
        ...
        self.p.v_pd_hf_tweezer_1064_ramp_end = 6.8
        ...
        # self.xvar('i_hf_tweezer_evap1_current',np.linspace(192.5,194.,8))
        ...
        # self.xvar('t_hf_tweezer_1064_rampdown',np.linspace(20.,220.,10)*1.e-3) 

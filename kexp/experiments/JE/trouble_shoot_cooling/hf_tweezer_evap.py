...
class mag_trap(EnvExperiment, Base):
    ...
    def prepare(self):
        ...
        # self.xvar('v_pd_hf_lightsheet_rampdown_end',np.linspace(.5,2.,15))
        self.p.v_pd_hf_lightsheet_rampdown_end = 1.14
        ...
        # self.xvar('v_hf_tweezer_paint_amp_max',np.linspace(-1.5,1.,15))
        self.p.v_hf_tweezer_paint_amp_max = -.5

        # self.xvar('t_hf_tweezer_1064_ramp',np.linspace(.05,.6,15))
        # self.p.t_hf_tweezer_1064_ramp = .2

        # self.xvar('i_hf_tweezer_evap1_current',np.linspace(192.,194.8,20))
        self.p.i_hf_tweezer_evap1_current = 193.9

        # self.xvar('v_pd_hf_tweezer_1064_rampdown_end',np.linspace(.2,2.,8))
        self.p.v_pd_hf_tweezer_1064_rampdown_end = 1.5

        # self.xvar('t_hf_tweezer_1064_rampdown',np.linspace(20.,150.,8)*1.e-3) 
        self.p.t_hf_tweezer_1064_rampdown = 130.e-3        

        # self.xvar('i_hf_tweezer_evap2_current',np.linspace(188.,194.,15))
        self.p.i_hf_tweezer_evap2_current = 192.3

        # self.xvar('v_pd_hf_tweezer_1064_rampdown2_end',np.linspace(.08,.44,20))
        self.p.v_pd_hf_tweezer_1064_rampdown2_end = .18

        # self.xvar('t_hf_tweezer_1064_rampdown2',np.linspace(100.,800.,8)*1.e-3) 
        self.p.t_hf_tweezer_1064_rampdown2 = 600.e-3  
        ...
        self.p.hf_imaging_detuning = -610.e6

...
class mag_trap(EnvExperiment, Base):
    ...
    def prepare(self):
        ...
        self.p.i_hf_tweezer_load_current = 192.8
 
        # self.xvar('v_pd_hf_tweezer_1064_ramp_end',np.linspace(4.,9.2,10))
        # self.p.v_pd_hf_tweezer_1064_ramp_end = 9.

        # self.xvar('v_hf_tweezer_paint_amp_max',np.linspace(-1.,6.,10))
        self.p.v_hf_tweezer_paint_amp_max = 6.

        # self.xvar('t_hf_tweezer_1064_ramp',np.linspace(.05,.6,15))
        self.p.t_hf_tweezer_1064_ramp = .2

        # self.xvar('i_hf_tweezer_evap1_current',np.linspace(192.,195.,15))
        self.p.i_hf_tweezer_evap1_current = 193.7

        # self.xvar('v_pd_hf_tweezer_1064_rampdown_end',np.linspace(.4,4.,8))
        self.p.v_pd_hf_tweezer_1064_rampdown_end = 1.4

        # self.xvar('t_hf_tweezer_1064_rampdown',np.linspace(20.,800.,8)*1.e-3) 
        self.p.t_hf_tweezer_1064_rampdown = 250.e-3        

        # self.xvar('i_hf_tweezer_evap2_current',np.linspace(192.5,195.,8))
        self.p.i_hf_tweezer_evap2_current = 193.2

        # self.xvar('v_pd_hf_tweezer_1064_rampdown2_end',np.linspace(.15,.3,10))
        self.p.v_pd_hf_tweezer_1064_rampdown2_end = .25

        # self.xvar('t_hf_tweezer_1064_rampdown2',np.linspace(200.,1000.,8)*1.e-3) 
        self.p.t_hf_tweezer_1064_rampdown2 = 420.e-3  

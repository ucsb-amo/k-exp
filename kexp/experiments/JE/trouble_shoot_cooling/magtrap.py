...
class mag_trap(EnvExperiment, Base):
    ...
    def prepare(self):
        ...
        self.xvar('detune_d2v_r_2dmot',np.linspace(-9.,-3.,8))
        ...
        # self.xvar('detune_d2_r_mot',np.linspace(-8.,-3.,8))

...
class tweezer_load(EnvExperiment, Base):
    ...
    def prepare(self):
        ...
        # self.xvar('t_tof',[300*1.e-6]*3)

        # self.xvar('beans',[0]*5)

        # self.xvar('t_tunnel',np.linspace(10.,500.,10)*1.e-3)
        self.p.t_tunnel = 1000.e-3
        ...
        # self.xvar('t_tweezer_1064_rampdown2',np.linspace(0.05,.6,20))

        # self.xvar('v_tweezer_paint_amp_max',np.linspace(-4.5,0.,20))
        self.p.v_tweezer_paint_amp_max = -3.

        # self.xvar('v_pd_tweezer_1064_rampdown3_end',np.linspace(.2,.5,20))
        self.p.v_pd_tweezer_1064_rampdown3_end = .34
    ...
    def scan_kernel(self):
        ...
        self.tweezer.set_amp(0,self.p.amp_final)

...
class tweezer_load(EnvExperiment, Base):
    ...
    def prepare(self):
        ...
        # self.xvar('t_raman_pulse',(3*(6.05e-6)) + np.linspace(-6.05e-6,6.05e-6,10))
        self.xvar('t_raman_pulse',[12.1e-6,(12.1e-6)*2])
        # self.p.t_raman_pulse = 12.1e-6 # pi time
        
        # self.xvar('t_measure',np.linspace(0.,25.e-6,20))
        self.p.t_measure = 100.e-6
        ...
        # self.xvar('amp_imaging',np.linspace(0.1,.13,5))
    ...
    def scan_kernel(self):
        ...
        self.tweezer.ramp(t=10.e-3,v_start=self.p.v_pd_lf_tweezer_1064_rampdown2_end,
                          v_end=.04,paint=True,keep_trap_frequency_constant=False)
        delay(10.e-3)
        self.tweezer.ramp(t=10.e-3,v_start=.04,
                          v_end=self.p.v_pd_lf_tweezer_1064_rampdown2_end,paint=True,keep_trap_frequency_constant=False)

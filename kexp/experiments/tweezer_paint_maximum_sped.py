...
class tweezer_paint(EnvExperiment, Base):
    ...
    def build(self):
        ...
        self.p.t_feshbach_field_rampup = 30.e-3
        self.p.t_feshbach_field_ramp = 20.e-3
        self.p.t_feshbach_field_ramp2 = 20.e-3

        # self.xvar('t_lightsheet_rampup',np.linspace(0.05,0.3,5))
        self.p.t_lightsheet_rampup = 0.5
        self.p.t_lightsheet_rampdown = 0.01

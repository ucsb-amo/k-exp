...
class tweezer_load(EnvExperiment, Base):
    ...
    def prepare(self):
        ...
        self.p.v_pd_lf_tweezer_1064_ramp_end = 8.3
        # self.xvar('v_pd_lf_tweezer_1064_ramp_end',np.linspace(7.3,8.8,7))

        self.p.v_lf_tweezer_paint_amp_max = -2.33
        # self.xvar('v_lf_tweezer_paint_amp_max',np.linspace(-4.,-2.,7))

        self.p.i_lf_tweezer_evap1_current = 13.5
        self.p.i_lf_tweezer_evap2_current = 14.0

        self.p.v_pd_lf_tweezer_1064_rampdown_end = 2.6
        # self.xvar('v_pd_lf_tweezer_1064_rampdown_end',np.linspace(1.5,8.,13))
        ...
        self.xvar('t_tof',np.linspace(100.,2000.,9)*1.e-6)
        self.p.t_tof = 100.e-6

        self.p.t_tweezer_hold = 1.e-3

        self.p.imaging_freq=385.e6
        # self.xvar('imaging_freq',np.linspace(170.,690.,18)*1.e6)

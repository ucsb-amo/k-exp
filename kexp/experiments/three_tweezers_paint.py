...
class tweezer_load(EnvExperiment, Base):
    ...
    def prepare(self):
        ...
        # self.xvar('t_tof',np.linspace(3000.,3000.,10)*1.e-6)
        ...
        self.xvar('v_pd_tweezer_1064_rampdown3_end',np.linspace(.45,1.5,10)) 
        # self.p.v_pd_tweezer_1064_rampdown3_end = .68

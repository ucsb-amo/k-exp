...
class tweezer_load(EnvExperiment, Base):
    ...
    def prepare(self):
        ...
        # self.xvar('i_lf_evap2_current',np.linspace(12.,16.,15))
        # self.xvar('i_lf_evap3_current',np.linspace(11.,15.,8))

        self.p.i_lf_evap1_current = 13.43
        self.p.i_lf_evap2_current = 14.5

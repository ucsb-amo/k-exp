...
volatile float set1 = 3.0f, kp1 = 0.10f, ki1 = 0.10f, kd1 = 0.0f, g1 = 0.5f, dV = 5.0f;
...
void pid1() {
  ...
  y_prev = y;
  dy_filt = dy_filt + D_ALPHA * (dy - dy_filt);
  
  integ1 += pid_err * ki1 * DT_SEC;
  float u_total = g1 * ((kp1 * pid_err) + integ1 - (kd1 * dy_filt));

...
class RamanBeamPair():
    ...
    def _init(self):
        # self._frequency_center_dds = (self.dds0.frequency + self.dds1.frequency)/2
        # if abs(self._frequency_center_dds - self.dds0.frequency) != abs(self._frequency_center_dds - self.dds1.frequency):

...
with program():
    ...
    play('cw', 'raman_80'); play('cw', 'raman_150')           # 1000 ns sticky latch; tone holds all run
...
\file{kexp/config/dds\_id.py} lines 84--86 and 110--112.}
\label{tab:elements}
\end{table}

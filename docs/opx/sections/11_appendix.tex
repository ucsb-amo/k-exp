...
manual-OPX flops at the same settings. Resolve the amplitude gap (OPX drives
at the bare dds defaults 0.337/0.324\,V versus ARTIQ's $\sqrt{0.3}\times$
default) and re-measure \code{t\_raman\_pi\_pulse} for the OPX drive. Measure
